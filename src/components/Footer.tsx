    ...
    >
      ...
      />
                    ...
                    <div className="flex gap-3 sm:gap-4 items-center flex-shrink-0 cursor-pointer">
                        <div className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-[#FD853A] rounded-full flex items-center justify-center mb-1">
                            <svg width="20" height="20" className="sm:w-6 sm:h-6 lg:w-6 lg:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <text x="4" y="18" fontSize="12" className="sm:text-sm lg:text-base" fontWeight="bold" fill="white">AH</text>
                            </svg>
                        </div>
                        <span className="font-bold text-base sm:text-lg tracking-wide cursor-pointer">ADITI</span>
                    </div>
                    <p className="w-full h-auto lg:h-[61px] text-[16px] sm:text-[18px] lg:text-[20px] text-[#FCFCFD]">Whether it’s designing user-friendly interfaces or building seamless digital experiences, I’m here to help. Let’s connect and collaborate on your next big idea.</p>
            ...
            <div className="flex flex-col sm:flex-row w-full max-w-[1298px] h-auto lg:h-[26px] items-start justify-between gap-4 sm:gap-0 mt-6 md:mt-0">
                <p className="w-full sm:w-[415px] h-auto lg:h-[26px] text-[16px] sm:text-[18px] lg:text-[20px] text-white text-center sm:text-left">Copyright© 2025 Aditi. All Rights Reserved.</p>
